...
const RescheduleAppointment = (props) => {
    ...
    const onDaySelect = async (slectedDate, doctorId, type) => {
        ...
        const newRes = await getAvailableSlotTimings(
            dataForSelectedDay,
            apptType
        ...
        if (newRes.status === 200) {
            ...
            if (apptType === 'FOLLOW_UP')
                setAppointmentSlot(slotsDisplayed.reverse());
            setDisplayCalendar(false);
            setDisplaySlot(true);
        }
    };
                                ...
                                <>
                                        ...
                                        <Col xs={12} id="doc-details">
                                            <div>
                                                <p className="doc-name">
                                                    {doctor.salutation} {doctor.firstName}{' '}
                                                    {doctor.lastName}
                                                </p>
                                                <ul
                                                    style={{
                                                                ...
                                                                availableSlotsDisplay.data.map(
                                                                    (slot, index) => (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <span>{slot.count} slots available</span>
                                                                        </div>
                                                                    )
                                                                )}
                                                        </div>
                                    ...
                                    <div className="mr-4 ml-4">
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                <b>
                                                    <span style={{ fontSize: 14 }}>Languange</span>
                                                </b>
                                                <br />
                                    ...
                                    <div className="ml-4">
                                        {doctor.bio && (
                                            <b>
                                                <p style={{ fontSize: 14, margin: '0 auto' }}>About</p>
                                            </b>
                                        )}
                                        <p style={{ fontSize: 14 }}>
                                    ...
                                    {displaySlot && (
                                        <>
                                            ...
                                            <p className="mt-3">
                                                ...
                                                Slots For {moment(currentDate).format('DD, MMMM YYYY')}
                                            </p>
                                ...
                                <Col xs={12}>
                                    <div className="doc-img">
                                        {doctor.picture ? (
                                            ...
                                            <Avatar name={doctor.firstName + ' ' + doctor.lastName} />
                                        )}
                                    </div>
                                </Col>
                                <Col xs={12} id="doc-details">
