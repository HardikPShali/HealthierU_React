...
const PaypalMobile = () => {
    ...
    const handleFreeCouponTransactions = async () => {
        ...
        if (promoCodeApplied === true && promoCodeEntered === 'HEALTHIERUAE' && (appointmentModeParams === 'First Consultation' || appointmentModeParams === 'FIRST_CONSULTATION')) {
        ...
        } else if (promoCodeApplied === true && promoCodeEntered === 'HEALTHIERUAE' && (appointmentModeParams === 'Follow Up' || appointmentModeParams === 'FOLLOW_UP')) {
            finalAppointmentDataArray = {
                id: appointmentIdParams,
                type: 'FOLLOW_UP',
                paymentsAppointmentsDTO: {
